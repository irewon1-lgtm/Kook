#!/usr/bin/env python3
"""KR4 standard actual recovery V2: recover every safe residual M01/M02 cell.

This entrypoint reuses the validated core resolver but removes the old
"immediately four-metric-completable only" restriction.
...
- the validated core still enforces completed, actual, non-consensus periods and
  fail-closed live-source handling.
"""
...
def wrapper_self_test() -> None:
    ...
    print("STANDARD_ACTUAL_RECOVERY_V2_WRAPPER_SELF_TEST_PASS")
